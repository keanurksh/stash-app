...
export function LandingNavbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#3b4b3c]/30 bg-[#181c1d]/75 shadow-sm backdrop-blur-md">
      <div className="mx-auto grid h-16 w-full max-w-7xl grid-cols-[1fr_auto_1fr] items-center px-4 md:px-8">
        <Link
          href="/"
          className="group flex items-center gap-1.5 justify-self-start font-space text-lg font-bold tracking-tight text-[#b2ffbe] md:gap-2 md:text-xl"
        >
          <Image
            src="/logo.png"
            alt="Stash"
